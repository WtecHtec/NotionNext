...
import { getConfigAiBotPromptConfigPage }  from '@/lib/notion/getAiBotPrompt'
...
async function convertNotionToSiteData(pageId, from, pageRecordMap) {
  ...
  const AI_BOT_PROMPT = await getConfigAiBotPromptConfigPage(collectionData) || ""
  NOTION_CONFIG.AI_BOT_PROMPT = AI_BOT_PROMPT
  // 处理每一条数据的字段
